...
Geometry::Geometry() : vao(0), vertexBuffer(0), normalBuffer(0), uvBuffer(0), colorBuffer(0), gradientShader(false), cullBackFace(false), isTransparent(false), hasShadow(true){
