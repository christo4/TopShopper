...
enum EntityTypes {
	...
	// PICKUPS...
	GROCERY_ITEM_MILK,					// COMPONENTS = AUDIO_SOURCE, MESH 
	GROCERY_ITEM_WATER,					// COMPONENTS = AUDIO_SOURCE, MESH
	GROCERY_ITEM_COLA,					// COMPONENTS = AUDIO_SOURCE, MESH
	GROCERY_ITEM_APPLE,					// COMPONENTS = AUDIO_SOURCE, MESH
	GROCERY_ITEM_WATERMELON,			// COMPONENTS = AUDIO_SOURCE, MESH
	GROCERY_ITEM_BANANA,				// COMPONENTS = AUDIO_SOURCE, MESH
	GROCERY_ITEM_CARROT,				// COMPONENTS = AUDIO_SOURCE, MESH
	GROCERY_ITEM_EGGPLANT,				// COMPONENTS = AUDIO_SOURCE, MESH
	GROCERY_ITEM_BROCCOLI,				// COMPONENTS = AUDIO_SOURCE, MESH
